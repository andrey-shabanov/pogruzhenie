...
if (!empty($_POST['submit'])){
    if (editAvatar($user_id)){
//    var_dump($_FILES['file'], $_POST['submit'], editAvatar($user_id));
//    die();
        setFlashMessage('success', 'Профиль обновлён!!!');
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    <img src="<?php (!empty($user['picture']))? print ('uploads/' . $user['picture']): print 'uploads/avatar.png'?>" alt="" class="img-responsive" width="200">
                                </div>
                                ...
                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button class="btn btn-warning" value="submit" name="submit">Загрузить</button>
                                </div>
                            </div>
                        </div>
                    </div>
